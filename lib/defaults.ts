...
export const defaultContent: SiteContent = {
  ...
  faqs: [
    ...
    { q: "إيه المراحل والفروع اللي بتتشرح؟", a: "المرحلة الإعدادية: منهج اللغة العربية كاملاً. المرحلة الثانوية: النحو، والصرف، والبلاغة، والأدب والنصوص — كل فرع بمنهجه وتدريباته." },
