...
const APPEARANCE_KEYS = new Set([
  ...
  "toolbarStyle", "navbarStyle", "navbarStick", "toolbarStick", "navbarHidden", "toolbarHidden", "appIcon", "appIconImage", "buttonStyle", "glow", "heroShell", "heroShellOpts", "iconFrame", "iconFrameColors", "iconMotion", "developer", "maintenance", "mobileHome", "motionStyle",
