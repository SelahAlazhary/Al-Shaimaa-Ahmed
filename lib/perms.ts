...
const APPEARANCE_KEYS = new Set([
  ...
  "toolbarStyle", "navbarStyle", "navbarStick", "toolbarStick", "navbarHidden", "toolbarHidden", "appIcon", "buttonStyle", "glow", "heroShell", "heroShellOpts", "developer", "mobileHome", "motionStyle",
